...
- A browser-downloaded exact candidate passes checksum, quarantine, Gatekeeper,
  drag installation, first launch, and the core capture workflow on the
  maintainer's latest-stable macOS host.
...
browser/Gatekeeper/core smoke defined above. This does not relax signing,
