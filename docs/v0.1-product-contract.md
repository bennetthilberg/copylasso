...
- Permission denial and recovery, global-shortcut and menu invocation,
  ...
  their release checks. Enabled-login-item restart, ordinary reinstall,
  complete uninstall/reinstall, clone recreation, and a latest-stable guest VM
  remain explicit maintainer-accepted evidence gaps for v0.1; their automated
  contracts and documented procedures remain required.
