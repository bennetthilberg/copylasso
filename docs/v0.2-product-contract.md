...
Capture LaTeX appears only if G39 passes every approved gate and G40 ships an
approved design. G39 does not decide how a future math result participates in
the unified Capture precedence; that remains an explicit G40 product-contract
decision. G40 is omitted if G39 concludes no-go.
