...
On sleep or lock the controller dismisses permission recovery and cancels any active operation. Wake or unlock does not restore a panel, cursor override, task, or capture automatically.
