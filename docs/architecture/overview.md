...
| G53 | CopyLasso-authored ellipsis removal, complete bounded HUD prefixes, and About spacing verification |
| G54 | `0.3.0 (6)` release-source freeze, migration/integration audit, generic G55 candidate enablement, and private qualification package |
