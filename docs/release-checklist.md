...
- [ ] Run focused updater tests, privacy/security and dependency audits, canonical arm64/x86_64 pipelines, hosted macOS checks, Developer ID/notarization/Gatekeeper verification, exact-head review, and ready-PR readback.
