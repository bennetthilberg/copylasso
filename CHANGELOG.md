...
- Selection now establishes the system crosshair immediately and reasserts it through AppKit's activation handoff, including a corrected cross-display input-readiness race.
