...
**Status:** Approved privacy contract for CopyLasso 0.1.x and the updater, configurable success sound, and Capture Code workflow present in source for the planned v0.2 release.
