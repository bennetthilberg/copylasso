...
content reaches the clipboard; cancellation, no result, permission denial,
recognition failure, and clipboard failure remain silent.

The same **Capture** action and shortcut recognize QR, Code 128, Data Matrix,
