...
readonly g46_product_patch_tree_pattern=$'\t(CHANGELOG\\.md|CopyLasso/App/CopyLassoApp\\.swift|CopyLasso/App/GlobalShortcutController\\.swift|CopyLasso/App/SystemGlobalShortcutEventSource\\.swift|CopyLasso/CaptureWorkflow/CaptureCommand\\.swift|CopyLasso/Models/SelectionGeometry\\.swift|CopyLasso/Services/AppKitRegionSelectionService\\.swift|CopyLasso/Services/InteractiveCaptureService\\.swift|CopyLasso/Services/RegionSelectionService\\.swift|CopyLasso/Services/SystemInteractiveCaptureService\\.swift|CopyLasso/Services/SystemScreenCaptureService\\.swift|CopyLasso/SharedUI/AboutView\\.swift|CopyLasso/SharedUI/MenuBarMenuView\\.swift|CopyLasso/SharedUI/SettingsView\\.swift|CopyLassoTests/App/GlobalShortcutControllerTests\\.swift|CopyLassoTests/App/MenuBarShellTests\\.swift|CopyLassoTests/CaptureWorkflow/CaptureCommandTests\\.swift|CopyLassoTests/CaptureWorkflow/CapturePermissionFlowTests\\.swift|CopyLassoTests/CaptureWorkflow/CaptureWorkflowIntegrationTests\\.swift|CopyLassoTests/CaptureWorkflow/InteractiveCaptureWorkflowTests\\.swift|CopyLassoTests/Models/MultiDisplayBehaviorTests\\.swift|CopyLassoTests/Services/AppKitRegionSelectionServiceTests\\.swift|CopyLassoTests/Services/SystemInteractiveCaptureServiceTests\\.swift|CopyLassoTests/Services/SystemInteractiveSelectionTrackerTests\\.swift|CopyLassoTests/Services/SystemScreenCaptureServiceTests\\.swift|CopyLassoTests/TestSupport/CaptureServiceDoubles\\.swift|CopyLassoTests/TestSupport/SettingsDoubles\\.swift|CopyLassoUITests/CopyLassoUITests\\.swift|PRIVACY\\.md|README\\.md|docs/architecture/capture-workflow\\.md|docs/architecture/overview\\.md|docs/security-and-privacy-review\\.md|docs/testing\\.md|scripts/audit-g46-product-patch\\.sh|scripts/audit-privacy-security\\.sh|scripts/audit-v02-release-qualification\\.sh|scripts/ci\\.sh|scripts/test-ci-contract\\.sh)$'
...
readonly expected_g44_release_state_files_digest='20d0b760a61db6de40caf947acb7ac0613c5e930df9005d445348e766fdfd8de'
readonly expected_approved_post_candidate_patch_digest='8061a8a309335b535ae44476fd56ff12c5b71e78befe5ea48fb6e79f179fcc53'
