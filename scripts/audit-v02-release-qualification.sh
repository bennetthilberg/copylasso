...
readonly g53_interface_copy_tree_pattern=$'\t(CHANGELOG\.md|CopyLasso/Models/FeedbackPreview\.swift|CopyLasso/SharedUI/AboutView\.swift|CopyLasso/SharedUI/MenuBarMenuView\.swift|CopyLasso/SharedUI/PermissionRecoveryPanel\.swift|CopyLasso/SharedUI/SecureUpdatePresentation\.swift|CopyLasso/SharedUI/SettingsView\.swift|CopyLassoTests/CaptureWorkflow/CapturePermissionFlowTests\.swift|CopyLassoTests/Models/FeedbackPreviewTests\.swift|CopyLassoTests/SharedUI/PermissionRecoveryTests\.swift|CopyLassoUITests/CopyLassoUITests\.swift|scripts/audit-capture-history\.sh|scripts/audit-interface-copy\.sh|scripts/audit-v02-release-qualification\.sh|scripts/ci\.sh|scripts/test-ci-contract\.sh)$'
...
readonly expected_g48_baseline_tree_digest='10472c87ac53a5f41fe376bec7e0b403c3b53201ad75050ce56e58e534588656'
...
readonly expected_approved_post_candidate_patch_digest='eb0f2827b27c23e468b6bd3d2844b62704d4018bd70c55d06c4a7c7e1a363285'
