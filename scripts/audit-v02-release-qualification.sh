...
readonly g53_interface_copy_tree_pattern=$'\t(CHANGELOG\.md|CopyLasso/Models/FeedbackPreview\.swift|CopyLasso/SharedUI/AboutView\.swift|CopyLasso/SharedUI/MenuBarMenuView\.swift|CopyLasso/SharedUI/PermissionRecoveryPanel\.swift|CopyLasso/SharedUI/SecureUpdatePresentation\.swift|CopyLasso/SharedUI/SettingsView\.swift|CopyLassoTests/CaptureWorkflow/CapturePermissionFlowTests\.swift|CopyLassoTests/Models/FeedbackPreviewTests\.swift|CopyLassoTests/SharedUI/PermissionRecoveryTests\.swift|CopyLassoUITests/CopyLassoUITests\.swift|README\.md|docs/architecture/clipboard-and-feedback\.md|docs/testing\.md|scripts/audit-capture-history\.sh|scripts/audit-interface-copy\.sh|scripts/audit-v02-release-qualification\.sh|scripts/ci\.sh|scripts/test-ci-contract\.sh)$'
...
readonly expected_approved_post_candidate_patch_digest='82144807cd2784171efda1611857fbef80c75cf30c769405c30a782b0940132b'
