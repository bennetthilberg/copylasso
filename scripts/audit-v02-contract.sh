...
for required_text in \
    ...
    '**Implementation status:** In progress; the secure updater, configurable success sound, and Capture Code are implemented in source but are not part of the public CopyLasso 0.1.1 download.' \
