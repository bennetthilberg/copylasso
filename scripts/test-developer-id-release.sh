...
expect_failure "version 0.2.0" assert_release_metadata "$temporary_directory/wrong-version.plist"
...
expect_failure "build 3" assert_release_metadata "$temporary_directory/wrong-build.plist"
