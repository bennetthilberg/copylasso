...
expect_failure "version 0.2.1" assert_release_metadata "$temporary_directory/wrong-version.plist"
...
expect_failure "build 4" assert_release_metadata "$temporary_directory/wrong-build.plist"
