...
expect_failure "version 0.2.2" assert_release_metadata "$temporary_directory/wrong-version.plist"
...
expect_failure "build 5" assert_release_metadata "$temporary_directory/wrong-build.plist"
